                                        ...
                                        "items": {
                                            ...
                                            "properties": {
                                                "u": {
                                                    "type": "string",
                                                    "description": (
                                                        "Absolute download URL only; never Watch Resulation/watch/stream/player/watch-online URL. "
                                                        "Copy the exact original Markdown href. Never shorten, decode, rebuild, "
                                                        "sanitize, or alter the original URL or its path/query fragments."
                                                    ),
                                                },
                                                "l": {
                                                    "oneOf": [
